// NOTA IMPORTANTE PARA SEO:
// Este serviço define meta tags dinamicamente no lado do cliente. Para garantir
// que os crawlers de motores de busca e plataformas de redes sociais consigam ler
// estas tags de forma eficaz para SEO e partilha, é altamente recomendável
// implementar Server-Side Rendering (SSR) ou Static Site Generation (SSG)
// no projeto Angular. Sem SSR/SSG, os crawlers podem não executar o JavaScript
// necessário para ver as tags atualizadas.
...
export class MetaTagService {
  ...
  private defaultKeywords = ['informática', 'consultadoria', 'Web', 'desenvolvimento', 'laravel', 'angular', 'AI', 'AiAgents'];
  ...
  setPageTags(title: string, description: string, image?: string, keywords?: string[]): void {
    const pageTitle = title ? `${title} | ${this.defaultAppName}` : this.defaultTitle;
    ...
    const pageTags: MetaTag[] = [
      ...
      { name: 'keywords', content: keywords ? keywords.join(', ') : this.defaultKeywords.join(', ') },
      // Facebook / Open Graph
